...
<body id="page-top" >
        ...
        <ul>
            ...
            <li class='ativo'>
                ...
                <ul class="feat-show">
                    ...
                    <li class='ativo'><a href="emprestimos_atrasados.php">ATRASADOS</a></li>
                </ul>
            </li>
            <?php
                    ...
                    <section class="register-photo" style="color: rgb(255,255,255);background: #f9f9f9;padding: 25px;padding-top: 25px;width: 100%;">
                        ...
                        <section data-aos="zoom-in" data-aos-duration="500" class="register-photo" style="color: rgb(133, 135, 150);background: rgb(255,255,255);margin: 0px;box-shadow: 0px 0px 4px rgb(114,114,125);border-top-left-radius: 3px;border-top-right-radius: 3px;border-bottom-right-radius: 3px;border-bottom-left-radius: 3px;margin-top: 0px;width: 100%;padding-top: 10px;padding-bottom: 10px;padding-right: 2%;padding-left: 2%;">
                            <div class="container" style="width: 100%;padding: 0;margin-top: 0;">
                                <div class="intro">
                                    <h2 class="text-center" style="color: rgb(50,50,50);font-family: Nunito, sans-serif;border-color: rgb(0,0,0);"><strong>EMPRÉSTIMOS ATRASADOS</strong></h2>
                                </div>
                            </div>
                        </section>
                                                ...
                                                >
                                                    <thead style='font-size:18px; color: #fff !important;'>
                                                        <tr>
                                                            ...
                                                            <th style='width: 15% !important;'>Livro</th>
                                                            <th style='width: 20% !important;'>Valor da Multa</th>
                                                            <th style='width: 20% !important;'>Pessoa</th>
    ...
    <script type='text/javascript'>
        $(document).ready(function() {
            $('#listar-emprestimos').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "application/listar_emprestimos_atrasados.php",
                "language": {
    ...
    <!-- ------------------------------------------------------------------- -->
    <!-- ############ QUITANDO MULTA E FINALIZANDO EMPRESTIMO ############ -->
    <!-- ------------------------------------------------------------------- -->
    <?php
         // QUITANDO MULTA E FINALIZANDO EMPRESTIMO
         if(!empty($id)){
            ...
            $sql = 'UPDATE emprestimos SET situacao=0,multa=0,data_devolucao=?,hora_devolucao=? WHERE id_emprestimo=?';
            $param = [date('Y/m/d'), date('H:i:s'), $id];
            
            if ($conexao->atualizarRegistro($sql, $param)){
                echo "<script>window.location.href = 'emprestimos_atrasados.php?resultado=12';</script>";
            }else {
                echo "<script>window.location.href = 'emprestimos_atrasados.php?resultado=13';</script>";
            }
        }
    ?>
</body>
